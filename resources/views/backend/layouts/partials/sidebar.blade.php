    ...
    <div class="sidebar-header">
        <div class="logo">
            <a href="{{ route('admin.dashboard') }}">
                ...
                <img src="{{ asset('backend/assets/images/Logo_headway.png') }}" style="border-radius: 50%;width: 60px; ">
        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    @if ($usr->can('blogs.create') || $usr->can('blogs.view') || $usr->can('blogs.edit') || $usr->can('blogs.delete'))
                        <li>
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                    class="fa fa-rss"></i><span>Blogs</span>
                            </a>
                            <ul
                    ...
                    @if (
                        ...
                        <li>
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                    class="fa fa-ticket"></i><span>Membership
                                    Orders</span>
                            </a>
                            <ul
                    ...
                    @if (
                        ...
                        <li>
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                    class="fa fa-paper-plane"></i><span>Plans &
                                    AddOn Service</span>
                            </a>
                            <ul
                    ...
                    @if (
                        ...
                        <li>
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                    class="fa fa-users"></i><span>Teams</span>
                            </a>
                            <ul
                    ...
                    @if (
                        ...
                        <li>
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                    class="fa fa-briefcase"></i><span>Our
                                    Services</span>
                            </a>
                            <ul
                    ...
                    @if (
                        ...
                        <li>
                            <a href="javascript:void(0)" aria-expanded="true"><i
                                    class="fa fa-play-circle"></i><span>Video
                                    Gallery</span>
                            </a>
                            <ul
