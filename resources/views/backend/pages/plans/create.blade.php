                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="number" class="form-control" id="tax" name="tax"
                                        placeholder="Enter Tax" value="{{ old('tax') }}" required autofocus>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <select class="form-control " id="plan_type" name="plan_type" required>
                                        ...
                                        <option value="Service Plan"
                                            {{ old('plan_type') == 'Service Plan' ? 'selected' : '' }}>Service Plan
                                        </option>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="number" class="form-control" id="store_visit" name="store_visit"
                                        placeholder="Enter store visit" value="{{ old('store_visit') }}" required
                                        autofocus>
                                </div>
                            </div>
                            {{-- <div class="form-row">
