                        ...
                        <form action="{{ route('admin.plan.update', $admin->id) }}" method="POST"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="personal_meeting" name="personal_meeting"
                                        placeholder="Enter Personal Meeting" value="{{ $admin->personal_meeting }}"
                                        required autofocus>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="number" class="form-control" id="tax" name="tax"
                                        placeholder="Enter Tax" value="{{ $admin->tax }}" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <textarea required class="form-control" id="sort_desc" name="sort_desc">{{ $admin->sort_desc }}</textarea>
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="password">Description</label>
                                    <textarea class="form-control" id="description" name="description">{{ $admin->description }}</textarea>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <select class="form-control " id="plan_type" name="plan_type" required>
                                        <option value="Member Plan"
                                            {{ old('plan_type') == 'Member Plan' ? 'selected' : '' }}
                                            {{ $admin->plan_type == 'Member Plan' ? 'selected' : '' }}>
                                            Member Plan
                                        </option>
                                        <option value="Service Plan"
                                            {{ old('plan_type') == 'Service Plan' ? 'selected' : '' }}
                                        ...
                                        @foreach ($chunks as $chunk)
                                            <div class="col-md-4">
                                                ...
                                                @foreach ($chunk as $module)
                                                    <div>
                                                        <input type="checkbox" id="modules_{{ $module->id }}"
