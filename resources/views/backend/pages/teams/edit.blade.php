                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city"
                                        placeholder="Enter City" value="{{ $admin->city }}" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="dept" name="dept" required>
                                    ...
                                    <option value="founder"
                                        {{ old('dept', $admin->dept ?? '') == 'founder' ? 'selected' : '' }}>Founder
                                    </option>
                                    <option value="admin"
                                        {{ old('dept', $admin->dept ?? '') == 'admin' ? 'selected' : '' }}>Admin</option>
                                    <option value="trainer"
                                        {{ old('dept', $admin->dept ?? '') == 'trainer' ? 'selected' : '' }}>Trainer
                                    </option>
                                    <option value="it" {{ old('dept', $admin->dept ?? '') == 'it' ? 'selected' : '' }}>
                                        IT</option>
                                </select>
                            </div>
