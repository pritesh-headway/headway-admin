                        ...
                        <form action="{{ route('admin.ourteam.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Enter Name" required autofocus value="{{ old('name') }}" required>
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    <label for="name">City</label>
                                    <input type="text" class="form-control" id="city" name="city"
                                        placeholder="Enter City" autofocus value="{{ old('city') }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="dept" name="dept" required>
                                    ...
                                    <option value="founder" {{ old('dept') == 'founder' ? 'selected' : '' }}>Founder
                                    </option>
                                    <option value="admin" {{ old('dept') == 'admin' ? 'selected' : '' }}>Admin</option>
                                    <option value="trainer" {{ old('dept') == 'trainer' ? 'selected' : '' }}>Trainer
                                    </option>
                                    <option value="it" {{ old('dept') == 'it' ? 'selected' : '' }}>IT</option>
                                </select>
                            </div>
