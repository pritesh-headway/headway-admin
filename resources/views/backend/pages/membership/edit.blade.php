                        ...
                        <form action="{{ route('admin.membership.update', $admin->id) }}" method="POST"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <input type="text" name="bussiness_state" id="bussiness_state"
                                        class="form-control" value="{{ $admin->bussiness_state }}" readonly />

                                </div>
                                <div class="form-group col-md-6 col-sm-6">
                                    <label for="password">Bussiness Pincode</label>
                                    <input type="text" name="bussiness_pincode" id="bussiness_pincode"
                                        class="form-control" value="{{ $admin->bussiness_pincode }}" readonly />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <input type="text" name="bussiness_email" id="bussiness_email"
                                        class="form-control" value="{{ $admin->bussiness_email }}" readonly />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <input type="text" name="organization_type" id="organization_type"
                                        class="form-control" value="{{ $admin->organization_type }}" readonly />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    class="form-control" /> --}}
                                    <br />
                                    <a href="{{ asset('payment_receipts/' . $admin->payment_receipt) }}"
                                        target="_blank"><img
                                            src="{{ asset('payment_receipts/' . $admin->payment_receipt) }}"
                                            alt="Blog Image" width="150px" height="100px" /></a>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-6 col-sm-6">
                                    ...
                                    <select class="form-control " id="membership_status" name="membership_status">
                                        <option style="background-color: red;" value="Pending"
                                            {{ old('membership_status') == 'Pending' ? 'selected' : '' }}
                                            {{ $admin->membership_status == 'Pending' ? 'selected' : '' }}>
                                            Pending
                                        </option>
                                        <option style="background-color: orange;" value="Declined"
                                            {{ old('membership_status') == 'Declined' ? 'selected' : '' }}
                                            {{ $admin->membership_status == 'Declined' ? 'selected' : '' }}>
                                            Declined
                                        </option>
                                        <option style="background-color: green;" value="Approved"
                                            {{ old('membership_status') == 'Approved' ? 'selected' : '' }}
                                            {{ $admin->membership_status == 'Approved' ? 'selected' : '' }}>
                                            Approved
                                        </option>
                                    </select>
                                </div>
