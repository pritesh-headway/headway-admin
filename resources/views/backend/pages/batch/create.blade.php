    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Batch Create</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.batch.index') }}">All Batch</a></li>
                    <li><span>Create Batch</span></li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="batch_no" name="batch_no"
                                    placeholder="Enter Batch No" required autofocus value="{{ old('batch_no') }}">
                            </div>
                        </div>
