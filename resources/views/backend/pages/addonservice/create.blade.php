...
@section('title')
Add On Service Create - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Add On Service Create</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.addonservice.index') }}">All Add On Service</a></li>
                    <li><span>Create Add On Service</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Create New dd On Service</h4>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="Enter Name"
                                    required autofocus value="{{ old('title') }}" required>
                            </div>
                            <div class="form-group col-md-6 col-sm-12">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="on_store_visit" name="on_store_visit"
                                    placeholder="Enter No. Of Store Visit" value="{{ old('on_store_visit') }}" required
                                    autofocus>
                            </div>
                            <div class="form-group col-md-6 col-sm-6">
