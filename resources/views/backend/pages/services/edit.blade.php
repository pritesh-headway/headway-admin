        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Edit Service - {{ $admin->name }}</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Edit Service - {{ $admin->name }}</h4>
                    @include('backend.layouts.partials.messages')

                    <form action="{{ route('admin.service.update', $admin->id) }}" method="POST"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="plan_name" name="plan_name"
                                    placeholder="Enter Plan Name" value="{{ $admin->name }}" required autofocus>
                            </div>
                            <div class="form-group col-md-6 col-sm-12">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-6">
                                ...
                                <select class="form-control" id="parent_id" name="parent_id" required>
                                    ...
                                    <option value="{{ $val->id }}" {{ $admin->parent_id == $val->id ? 'selected' : ''
                                        }}>{{ $val->name }}
                                        @endforeach
                                    </option>
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 col-sm-12">
                                ...
                                <textarea class="form-control" id="service_desc"
                                    name="service_desc">{{ $admin->service_desc }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-6">
                                ...
                                <br />
                                <img src="{{ asset('services/'.$admin->image) }}" alt="Service Image" width="100px"
                                    height="80px" />
                            </div>
                            <div class="form-group col-md-6 col-sm-6">
