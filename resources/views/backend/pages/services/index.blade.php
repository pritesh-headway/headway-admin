...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">{{ __('Services') }}</h4>
                    <p class="float-right mb-2">
                        @if (auth()->user()->can('service.edit'))
                        <a class="btn btn-primary text-white" href="{{ route('admin.service.create') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success text-white"
                                            href="{{ route('admin.service.edit', $admin->id) }}">Edit</a>
                                        @endif
                                        ...
                                        <form id="delete-form-{{ $admin->id }}"
                                            action="{{ route('admin.service.destroy', $admin->id) }}" method="POST"
                                            style="display: none;">
                                            @method('DELETE')
                                            @csrf
                                        </form> --}}
