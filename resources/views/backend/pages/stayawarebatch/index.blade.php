...
@section('title')
{{ __('Stay Aware Alive Batch - Admin Panel') }}
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">{{ __('Stay Aware Alive Batch') }}</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li><span>{{ __('All Stay Aware Alive Batch') }}</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">{{ __('Stay Aware Alive Batch Request') }}</h4>
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->can('stayawarebatch.edit'))
                                        <a class="btn btn-success text-white"
                                            href="{{ route('admin.stayawarebatch.edit', $admin->id) }}">Detail</a>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
