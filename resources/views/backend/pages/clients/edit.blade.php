                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city"
                                        placeholder="Enter City" value="{{ $admin->city }}" required autofocus>
                                </div>
                            ...
                            {{-- <div class="form-row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_featured" id="featuredYes"
                                            value="1" {{ $admin->is_featured == 1 ? 'checked' : '' }} required>
                                        <label class="form-check-label" for="featuredYes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_featured" id="featuredNo"
                                            value="0" {{ $admin->is_featured == 0 ? 'checked' : '' }} required>
