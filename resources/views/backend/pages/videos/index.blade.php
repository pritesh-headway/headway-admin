    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">{{ __('Videos') }}</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li><span>{{ __('All Videos') }}</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">{{ __('Videos') }}</h4>
                    <p class="float-right mb-2">
                        @if (auth()->user()->can('videogallery.edit'))
                        <a class="btn btn-primary text-white" href="{{ route('admin.videogallery.create') }}">
                            {{ __('Create New Video') }}
                        </a>
                        @endif
                    </p>
