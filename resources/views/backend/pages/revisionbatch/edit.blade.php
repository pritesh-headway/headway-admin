...
@section('title')
Revision Batch Request - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Revision Batch View</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.revisionbatch.index') }}">All Revision Batch</a></li>
                    <li><span>View Revision Batch - {{ $admin->owner_name }}</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.revisionbatch.update', $admin->id) }}" method="POST"
                        ...
                        <a href="{{ route('admin.revisionbatch.index') }}"
