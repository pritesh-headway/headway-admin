...
use App\Http\Controllers\Backend\OneTimeRequestController;
use App\Http\Controllers\Backend\OrderAddOnController;
use App\Http\Controllers\Backend\PlanController;
use App\Http\Controllers\Backend\RevisionBatchApprovedController;
use App\Http\Controllers\Backend\RevisionBatchController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::post('onetimerequest/addUpdateOneTimeMeetingData', [OneTimeRequestController::class, 'addUpdateOneTimeMeetingData'])->name('onetimerequest.addUpdateOneTimeMeetingData');
